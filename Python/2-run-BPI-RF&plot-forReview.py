...
# define your features for modeling
...
ideal_feature_list = list(train_set.columns[list(range(160, 163)) + list(range(11, 158))])
...
other_features = list(['EAS', 'ACI_sum', 'year', 'day_of_year',
